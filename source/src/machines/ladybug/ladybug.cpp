...
// ============================================================================
// SN76489 dual-chip write (Mr. Do! pattern)
// Writes directly to sn_period[chip][ch] and sn_volume[chip][ch]
// which are read by audio.cpp::sn76489_render_buffer() for synthesis.
// ============================================================================
